...
برای اینکه در آینده گوگل شیت دوباره تاریخ‌های جلالی ورودی در شیت import_items را خودکار به میلادی تبدیل نکند، پیشنهاد می‌کنند کل ستون تاریخ در شیت منبع (import_items) را انتخاب کرده و از منوی Format > Number > Plain Text آن را روی متن خام تنظیم کنید. با این کار، خیالتان راحت خواهد بود که گوگل شیت هرگز دخالتی در داده‌های ورودی شما نخواهد داشت.
